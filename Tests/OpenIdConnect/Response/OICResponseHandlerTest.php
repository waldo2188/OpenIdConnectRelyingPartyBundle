...
class OICResponseHandlerTest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    public function testHandleTokenAndAccessTokenResponseShouldBeOk($alg, $token)
    {
        $response = new \Buzz\Message\Response();
     ...
     */
    public function testHandleEndUserinfoResponseShouldBeOk($headerApplicationType, $alg, $content)
    {
        $response = new \Buzz\Message\Response();
    ...
    private function createJWKSetHandler()
    {
